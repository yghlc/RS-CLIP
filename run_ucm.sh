...
$(which python) generate_pseudo.py --dataset ucm --vis-model ViT-L/14 --pseudo-version 1 --topk 30
...
# $(which python) train_zero.py --dataset ucm --vis-model ViT-L/14 --n-shot 20 --work-dir work_dir_ucm_ViTL_pseudo_k30 --pseudo-version 1
